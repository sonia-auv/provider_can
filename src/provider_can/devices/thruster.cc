...
Thruster::Thruster(const CanDispatcher::Ptr &can_dispatcher,
  ...
  thruster_pub_ = nh->advertise<sonia_msgs::ThrusterMsg>(
      thruster_specific_name_ + "_thruster_msgs", 100);
  thruster_properties_pub_ = nh->advertise<sonia_msgs::CanDevicesProperties>(
      thruster_specific_name_ + "_thruster_properties", 100);
