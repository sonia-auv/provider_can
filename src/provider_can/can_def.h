...
const uint8_t GET_PARAMETER_DLC = 4;
const uint8_t GET_PARAMETER_ADDR_DLC = 4;
const uint8_t GET_PARAMETER_DATA_DLC = 4;
const uint8_t SET_PARAMETER_DLC = 8;
const uint8_t SET_PARAMETER_ADDR_DLC = 4;
const uint8_t SET_PARAMETER_DATA_DLC = 4;
